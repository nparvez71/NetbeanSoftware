...
/*
 Modify Sketcher to print a single sketch laid out on four pages.
 The sketch should be enlarged to provide the best fit on the four pages
 without distorting circles—that is, the same scale should be applied to the x and y axes.
 */

/*
  This solution is based on the last version of Sketcher in Chapter 21, not on the
