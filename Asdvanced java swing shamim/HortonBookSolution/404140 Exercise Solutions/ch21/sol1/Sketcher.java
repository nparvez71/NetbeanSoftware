...
/*
 Modify the Sketcher program to print the title at the top of the page on which the sketch is printed.
 */

/*
  The additional code to do this is in the print() method in the SketchView class.
  This requires an import statement for java.awt.geom.Rectangle2D to
  be added to the SketcherView source file.
*/
