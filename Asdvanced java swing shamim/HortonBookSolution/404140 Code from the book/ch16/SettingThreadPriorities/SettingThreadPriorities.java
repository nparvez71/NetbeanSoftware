...
public class SettingThreadPriorities {
    ...
    public static void main(String[] args) {
      ...
      int transactionCount = 50;                                       // Number of debits and of credits
      int clerkCount = 2;
      ...
      Future<int[]> credits = threadPool.submit(new TransactionSource(TransactionType.CREDIT, transactionCount, accounts, clerks, Thread.MAX_PRIORITY-1));
      Future<int[]> debits = threadPool.submit(new TransactionSource(TransactionType.DEBIT, transactionCount, accounts, clerks, Thread.MIN_PRIORITY+1));
