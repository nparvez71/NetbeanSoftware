...
public class TryThreadInterrupted extends Thread {
  public TryThreadInterrupted(String firstName, String secondName, long delay) {
  ...
  public static void main(String[] args) {
    ...
    Thread first = new TryThreadInterrupted("Hopalong ", "Cassidy ", 200L);
    Thread second = new TryThreadInterrupted("Marilyn ", "Monroe ", 300L);
    Thread third = new TryThreadInterrupted("Slim ", "Pickens ", 500L);
